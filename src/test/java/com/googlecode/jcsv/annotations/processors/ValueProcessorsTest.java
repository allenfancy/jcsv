...
public class ValueProcessorsTest {
	...
	@Test
	public void testBooleanProcessor() {//测试 BooleanProcessor
		ValueProcessor<Boolean> processor = new BooleanProcessor();
		System.out.println(processor.processValue("true"));
		System.out.println(processor.processValue("false"));
		System.out.println(processor.processValue("1"));
		System.out.println(processor.processValue("0"));
		System.out.println(processor.processValue("22"));
	}
